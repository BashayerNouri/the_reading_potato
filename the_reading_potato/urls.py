...
urlpatterns = [
    ...
    path('contributions/<contribution_id>/', views.contribution_details, name="contribution-details"),
    path('accept/<contribution_id>/', views.accept_changes, name="accept-changes"),
    path('decline/<contribution_id>/', views.decline_changes, name="decline-changes"),
]
